...
class PermissionDeniedException implements Exception {
  ...
  PermissionDeniedException([this.message = 'Permission denied from Daemon']);

  @override
  String toString() => 'PermissionDeniedException: $message';
}

class TooManyRequestsException extends PermissionDeniedException {
  TooManyRequestsException([super.message = 'Too many calls made to the Daemon']);
}

class DaemonAuthenticationException extends PermissionDeniedException {
